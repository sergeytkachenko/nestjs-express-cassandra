...
function getSchema(entity) {
    const attributes = decorator_utils_1.getAttributes(entity.prototype);
    const _a = decorator_utils_1.getOptions(entity.prototype), { instanceMethods, classMethods } = _a, options = __rest(_a, ["instanceMethods", "classMethods"]);
