...
function addAttributeOptions(target, propertyName, options) {
    const attributes = getAttributes(target);
    attributes[propertyName] = deep_merge_utils_1.mergeDeep(attributes[propertyName], options);
    setAttributes(target, attributes);
}
...
function addOptions(target, options) {
    ...
    setOptions(target, deep_merge_utils_1.mergeDeep(mOptions, options));
}
exports.addOptions = addOptions;
exports.addHookFunction = (target, metadataKey) => {
