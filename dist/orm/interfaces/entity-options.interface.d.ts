...
export declare type ClusterOrder<T> = Partial<
...
declare type FilterOptions<T> = Partial<{ [P in keyof T]: FindSubQueryStatic }>;
...
declare type JanusGraphDataTypes =
  | 'Integer'
  | 'String'
  | 'Character'
  | 'Boolean'
