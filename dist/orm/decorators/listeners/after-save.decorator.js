...
function AfterSave() {
    return (target, propertyKey, descriptor) => {
        ...
        const { after_save } = decorator_utils_1.getOptions(target);
        if (!after_save) {
            decorator_utils_1.addOptions(target, { after_save: decorator_utils_1.addHookFunction(target, orm_constant_1.AFTER_SAVE) });
        }
        return descriptor;
    };
}
