...
function BeforeSave() {
    return (target, propertyKey, descriptor) => {
        ...
        const { before_save } = decorator_utils_1.getOptions(target);
        if (!before_save) {
            decorator_utils_1.addOptions(target, { before_save: decorator_utils_1.addHookFunction(target, orm_constant_1.BEFORE_SAVE) });
        }
        return descriptor;
    };
}
