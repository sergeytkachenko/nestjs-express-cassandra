...
let ExpressCassandraCoreModule = ExpressCassandraCoreModule_1 = class ExpressCassandraCoreModule {
    ...
    static forRoot(options = {}) {
        ...
        const connectionProvider = {
            provide: cassandra_orm_utils_1.getConnectionToken(options),
        ...
        return {
            ...
            providers: [
                ...
                connectionProvider,
                {
                    ...
                    useValue: cassandra_orm_utils_1.generateString(),
                },
            ],
            exports: [connectionProvider],
        };
    ...
    onModuleDestroy() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const connection = this.moduleRef.get(cassandra_orm_utils_1.getConnectionToken(this
                .options));
    ...
    static createConnectionFactory(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield rxjs_1.defer(() => connection.initAsync())
                .pipe(cassandra_orm_utils_1.handleRetry(retryAttempts, retryDelay), operators_1.map(() => connection))
                .toPromise();
        });
    }
};
ExpressCassandraCoreModule = ExpressCassandraCoreModule_1 = __decorate([
    common_1.Global(),
    common_1.Module({}),
    __param(0, common_1.Inject(express_cassandra_constant_1.EXPRESS_CASSANDRA_MODULE_OPTIONS)),
